export class Util {
    static loadText = function (filePath) {
    ...
    static getFullscreenQuad = function () {
    ...
    static createTexture = function (options, typedArray) {
    ...
    static createFramebuffer = function (context, colorTexture, depthTexture) {
    ...
    static createRawRenderState = function (options) {
    ...
    static viewRectangleToLonLatRange = function (viewRectangle) {
        var range = {};
